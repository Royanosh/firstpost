...
<div class="container">
    <div class="footerMain">
      ...
      <g id="" data-name="Group 1199" transform="translate(-290 -78)">
        ...
        <path id="" data-name="Icon feather-facebook"
          ...
          transform="translate(290.563 83.333)" fill="#fff"></path>
      </g>
    </svg>
                </a>
            </li>
      ...
      <g id="" data-name="Group 1200" transform="translate(-296 -132)">
        ...
        <path id="" data-name="Icon feather-twitter"
          ...
          transform="translate(302.5 136.515)" fill="#fff"></path>
      </g>
    </svg>
                </a>
            </li>
      ...
      <g id="XMLID_1346_">
        <radialGradient id="XMLID_2_" cx="0.5832" cy="73.0792" r="132.6155" gradientUnits="userSpaceOnUse">
          <stop offset="0" style="stop-color:#F4EC55"></stop>
          <stop offset="0.2412" style="stop-color:#E48242"></stop>
          <stop offset="0.3463" style="stop-color:#D66863"></stop>
          <stop offset="0.4422" style="stop-color:#CD4F74"></stop>
          <stop offset="0.4888" style="stop-color:#C94379"></stop>
          <stop offset="1" style="stop-color:#3F56A6"></stop>
        </radialGradient>
        <path id="XMLID_1418_" fill="url(#XMLID_2_)" d="M38.2,72.8L38.2,72.8C18.4,72.8,2.4,56.8,2.4,37l0,0c0-19.8,16.1-35.9,35.9-35.9h0
                    C58,1.1,74.1,17.2,74.1,37l0,0C74.1,56.8,58,72.8,38.2,72.8z"></path>
        <g id="XMLID_1347_">
          <path id="XMLID_1352_" fill="#FFFFFF" d="M38.2,20.9c5.3,0,5.9,0,7.9,0.1c1.9,0.1,3,0.4,3.7,0.7c0.9,0.4,1.6,0.8,2.3,1.5
                    ...
                    C44.3,17.3,43.6,17.3,38.2,17.3"></path>
          ...
          <path id="XMLID_1348_" fill="#FFFFFF" d="M51.1,26.5c0,1.3-1.1,2.4-2.4,2.4c-1.3,0-2.4-1.1-2.4-2.4c0-1.3,1.1-2.4,2.4-2.4
            ...
            <li>
                <a href="https://www.youtube.com/channel/UCz8QaiQxApLq8sLNcszYyJw/featured" rel="nofollow" target="_blank" class="yu sc-icon">
                    <svg width="30" height="30" preserveAspectRatio="xMidYMid" viewBox="0 0 512 512">
      <circle style="fill: #fff;" cx="256" cy="256" r="256"></circle>
      ...
      Facebook
        ...
        <div class="footerColumn">
            ...
            <ul class="footerLinks">
                ...
                <li><a href="entertainment.html" title="Entertainment News">Entertainment News </a></li>
                ...
                <li><a href="#" title="FirstCulture">Firstculture</a></li>
                <li><a href="#" title="Long Reads">Long Reads </a></li>
                <li><a href="#" title="Latest Mobiles">Latest Mobiles</a></li>
                <li><a href="#" title="Latest Tablets">Latest Tablets</a></li>
                <li><a href="#" title="Latest Laptops">Latest Laptops</a></li>
            </ul>
        </div>
        ...
        <div class="footerColumn">
            ...
            <ul class="footerLinks">
                ...
                <li><a href="#" title="FP Exclusives">Fp Exclusives</a></li>
                <li><a href="#" title="Board Exam Results 2020">Board Exam Results 2020 </a></li>
                <li><a href="#" title="IPL 2020">Ipl 2020 </a></li>
                <li><a href="#" title="Coronavirus">Coronavirus </a></li>
            </ul>
        </div>
  ...
  <path d="M0 0h24v24H0V0z" fill="none"></path>
        ...
        <ul class="otherSitesLinks">
            ...
            <li>
                <a href="https://www.news18.com/" target="_blank"> News18 </a>
            </li>
            <li>
                <a href="https://www.cnbctv18.com/" target="_blank"> CNBC TV18</a>
            </li>
            <li>
                <a href="https://overdrive.in/" target="_blank">Overdrive </a>
            </li>
            <li>
                <a href="https://www.forbesindia.com/" target="_blank"> Forbes India</a>
            </li>
            <li>
